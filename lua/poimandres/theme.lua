...
function M.get(config)
  ...
  theme = {
    ...
    Conditional = { fg = p.teal1 }, --  if, then, else, endif, switch, etc.
    Repeat = { fg = p.teal1 }, --   for, do, while, etc.
    Label = { fg = p.text }, --    case, default, etc.
    Operator = { fg = p.teal1 }, -- "sizeof", "+", "*", etc.
    Keyword = { fg = p.teal1 }, --  any other keyword
    Exception = { fg = p.teal1 }, --  try, catch, throw
    ...
    Type = { fg = p.blue3 }, -- (preferred) int, long, char, etc.
